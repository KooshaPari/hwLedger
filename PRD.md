...
- **FR-PLAN-004** [journey_kind: none]: Interactive sliders for Sequence Length, Concurrent Users, Batch Size, Weight Quant, KV Quant. Log scale on appropriate axes. (no-journey justification: SwiftUI Planner surface shipped with accessibility IDs; blackbox capture deferred behind TCC Accessibility/Screen-Recording grant — see GUI_CAPTURE_TODO.md.)
