...
<ShotGallery
  title="MQA memory footprint vs MHA"
  :shots='[
    {"src":"/cli-journeys/keyframes/first-plan/frame-007.png","caption":"KV cache row — 8× smaller for MQA vs MHA"},
    {"src":"/cli-journeys/keyframes/first-plan/frame-010.png","caption":"Component breakdown: the MQA KV band is barely visible at the same context length"}
  ]' />
