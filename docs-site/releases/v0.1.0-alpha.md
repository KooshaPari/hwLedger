...
<!-- SHOT-PENDING: macOS release build pipeline should get a dedicated signed-DMG capture; use the verified install path until that tape exists. -->
<RecordingEmbed tape="install-cargo" kind="cli" caption="CLI install verification for the alpha toolchain path; signed-DMG capture pending" />
