...
<!-- SHOT-PENDING: macOS release build pipeline could surface in the native app's About/Update panel; keep CLI tape as temporary stand-in until a GUI release journey is recorded -->
