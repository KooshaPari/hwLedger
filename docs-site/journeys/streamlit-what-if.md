...
<ShotGallery
  title="What-If — land, techniques, verdict"
  :shots='[
    {"src":"/streamlit-journeys/recordings/streamlit-what-if/frame-001.png","caption":"What-If page lands — Memory Prediction, compare baseline vs plan"},
    {"src":"/streamlit-journeys/recordings/streamlit-what-if/frame-004.png","caption":"Techniques selected — Baseline vs Result ledger visible"},
    {"src":"/streamlit-journeys/recordings/streamlit-what-if/frame-005.png","caption":"Verdict banner with delta and per-band breakdown"}
  ]' />
